...
def main():
    ...
    today_dates = [
        (10, 25), (10, 30), (11, 4), (11, 5), (11, 6), (11, 11), (11, 12), 
    ...
    for month, day in today_dates:
        ...
        crontab_entries.append(f"0 1 {twodays_before.day} {twodays_before.month} * /home/id2/.local/bin/threedays.sh > /dev/null 2>&1")
